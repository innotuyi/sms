    ...
    <div class="card-body">
        <form method="POST" action="{{ route('universities.store') }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('university_code') is-invalid @enderror" 
                               name="university_code" value="{{ old('university_code') }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('rector_name') is-invalid @enderror" 
                               name="rector_name" value="{{ old('rector_name') }}">
                        @error('rector_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control @error('accreditation_status') is-invalid @enderror" name="accreditation_status">
                            ...
                            <option value="Accredited" {{ old('accreditation_status') == 'Accredited' ? 'selected' : '' }}>Accredited</option>
                            <option value="Provisional" {{ old('accreditation_status') == 'Provisional' ? 'selected' : '' }}>Provisional</option>
                            <option value="Pending" {{ old('accreditation_status') == 'Pending' ? 'selected' : '' }}>Pending</option>
                        </select>
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary">Create University <i class="icon-paperplane ml-2"></i></button>
            </div>
        </form>
    </div>
</div>
