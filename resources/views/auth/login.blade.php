        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-lg h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">This platform provides comprehensive orientation on various educational institutions worldwide, emphasizing their unique focuses and geographical advantages. Users can explore detailed profiles of schools, including their academic strengths, extracurricular offerings, and facilities.</p>
                    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-lg h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">Imagine a website dedicated to guiding students through the maze of school options based on location and specialization. Our platform offers concise profiles of schools worldwide, spotlighting their unique academic strengths and extracurricular offerings.</p>
                    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-lg h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">With Rangishuri, no longer with struggling from knowing a very fit school where your child would go, where the option that a student wishes to pursue, making sure that you send your child to a school with a living condition that is known by the parents.</p>
                        <p class="card-text">Rangishuri is a platform registered under government of law by Rwanda Development Board. Our main aim is to easier ways of getting schools related information.</p>
                    </div>
