    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if (Qs::userIsTeamSAT())
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-books"></i> <span>Attendance</span></a>
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                            ...
                            {{-- Grades list --}}
                            <li class="nav-item">
                                <a href="{{ route('attendance.index') }}" class="nav-link"></a>
                            </li>
                ...
                @if (Qs::userIsTeamSAT())
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-books"></i> <span>Ressource</span></a>
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                            ...
                            {{-- Books --}}
                            <li class="nav-item">
                                <a href="{{ route('ressource.index') }}" class="nav-link">Ressource</a>
                            </li>

                            {{-- Borrow Book --}}
                            <li class="nav-item">
                                <a href="{{ route('ressource.upload') }}" class="nav-link">Upload Ressource</a>
                            </li>
                ...
                {{-- End Library --}}
                 ...
                 @if (Qs::userIsTeamSAT())
                 <li class="nav-item nav-item-submenu">
                     <a href="#" class="nav-link"><i class="icon-books"></i> <span>Past Papers</span></a>
                     ...
                     <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                         ...
                         {{-- past papers --}}
                         <li class="nav-item">
                             <a href="{{ route('past_papers.index') }}" class="nav-link">Past papesr</a>
                         </li>
             ...
             {{-- End past paper --}}
              ...
              @if (Qs::userIsTeamSAT())
              <li class="nav-item nav-item-submenu">
                  <a href="#" class="nav-link"><i class="icon-books"></i> <span>Expenses</span></a>
                  <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                      {{-- past papers --}}
                      <li class="nav-item">
          ...
          {{-- End past paper --}}
           ...
           @if (Qs::userIsTeamSAT())
           <li class="nav-item nav-item-submenu">
               <a href="#" class="nav-link"><i class="icon-books"></i> <span>Leave</span></a>
               <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                   {{-- past papers --}}
                   <li class="nav-item">
                       <a href="{{ route('leaves.index') }}" class="nav-link">Leave</a>
                   </li>
               </ul>
           </li>
       @endif
       {{-- End Leave --}}
         ...
         @if (Qs::userIsTeamSAT())
         <li class="nav-item nav-item-submenu">
             <a href="#" class="nav-link"><i class="icon-books"></i> <span>Payroll Manage</span></a>
             <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                 {{-- past papers --}}
                 <li class="nav-item">
                     <a href="{{ route('payrolls.index') }}" class="nav-link">Payroll</a>
                 </li>
             </ul>
         </li>
     @endif
     ...
     {{-- End payroll --}}
                ...
                @if (Qs::userIsTeamSAT())
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-books"></i> <span>Permission</span></a>
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Exams">
                            ...
                            {{-- Marks Batch Fix --}}
                            <li class="nav-item">
                                <a href="{{ route('marks.batch_fix') }}" class="nav-link">Batch Fix</a>
                            </li>
